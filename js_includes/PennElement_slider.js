// SCALE element
/* $AC$ PennController.newSlider(name,numberOrValues) Creates a new Scale element $AC$ */
/* $AC$ PennController.getSlider(name) Retrieves an existing Scale element $AC$ */
window.PennController._AddElementType("Slider", function(PennEngine) {
    ...
    async function buildScale(){                                  // Feeds this.jQueryElement according to scale type
        ...
        if (type=="slider"){                                        // Slider scale: special case
            ...
            slider[0].oninput = ()=>this.choice(slider[0].value); 
